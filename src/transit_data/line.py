...
def get_full_line(agency: str, line_id: str, route_id: str):
    ...
    return_line = {
        "route_id": route_id,
        "lineLongName": line["line_long_name"],
        "lineColor": line["line_color"],
        "lineTextColor": line["line_text_color"],
        # "lineSortOrder": line["line_sort_order"],
